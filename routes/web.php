...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/staff-reports/{year}/{month}', [StaffReportController::class, 'branch_yearly']);
    ...
    Route::get('/staff-old-reports/{year}/{month}', [StaffReportController::class, 'old_branch_yearly']);
