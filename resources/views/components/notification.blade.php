    ...
    <div class="chat-modal show  mr-5 flex flex-col mb-5 shadow-lg sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        <div class="flex justify-between items-center text-white p-2 bg-green-500 border shadow-lg mr-5 w-full">
            <div class="flex items-center">
                <h2 class="font-semibold tracking-wider">Nota</h2>
            </div>
        </div>
        <!-- chats -->
        ...
        <div class="relative bg-white">
            <input type="text" name="message" placeholder="Pesanan anda"
            class="pl-4 pr-16 py-2 border border-green-500 focus:outline-none w-full">
            <input type="date" name="until" placeholder="Sehingga"
            class="pl-4 pr-16 py-2 border border-green-500 focus:outline-none w-full">
            <button
            class="absolute right-0 bottom-0 text-green-600 bg-white  hover:text-green-500 m-1 px-3 py-1 w-auto transistion-color duration-100 focus:outline-none">Tambah</button>
        </div>
        @endif
    </div>
    <div
