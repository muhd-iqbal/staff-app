<x-app-layout>
    ...
    <x-modalbox width='max-w-xl'>
        ...
        <div class="flex justify-between items-center pb-3">
            <p class="text-2xl font-bold">Tambah Cheque</p>
        </div>
        <div class="pt-2 gap-2">
            <form action="/cheque-reports/add" method="POST">
                @csrf
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <section class="container mx-auto p-6 font-mono">
                    <div class="flex">
                        <div class="text-xl">Senarai Cheque</div>
                            ...
                            <tbody>
                                @foreach ($cheques as $cheque)
                                    <tr class="text-center">
                                        ...
                                        <td class="border">{{ RM($cheques->total) }}</td>
                                        <td class="border">
                                            <a href="/cheque-reports/{{ $cheques->id }}"
                                                class="bg-blue-500 p-1 px-2 text-white rounded-md hover:bg-blue-700">Lihat</a>
                                            <a href="/cheque-reports/{{ $cheques->id }}/edit"
