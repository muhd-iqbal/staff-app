                        ...
                        <div class="flex flex-col md:flex-row gap-5 my-2">
                            ...
                            <div class="flex md:flex-row-reverse">
                                <form action="/testing">
                                    ...
                                    <a href="/testing" class="text-2xl" title="Tunjuk semua">&#8635;</a>
                                </form>
                        ...
                        <div class="m-5 grid md:grid-cols-2">
                            <div>
                                @foreach ($branches as $branch)
                                    <div onclick="window.location='/testing/location/{{ $branch->id }}'"
                            ...
                            <div>
                                <div class="flex flex-col-reverse md:flex-row-reverse mt-5 gap-3">
                                    <div onclick="window.location='/testing/item/status/is_done'"
                                    ...
                                    <div onclick="window.location='/testing/item/status/is_approved'"
                                    ...
                                    <div onclick="window.location='/testing/item/status/is_design'"
                                    ...
                                    <div onclick="window.location='/testing/item/status/is_pending'"
                                ...
                                <div class="flex flex-row md:flex-row-reverse mt-5 gap-3">
                                    <div onclick="window.location='/testing?payment=paid'"
                                    ...
                                    <div onclick="window.location='/testing?payment=partial'"
                                    ...
                                    <div onclick="window.location='/testing?payment=unpaid'"
