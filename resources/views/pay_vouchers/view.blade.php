                ...
                <div class="p-6 bg-white">
                    ...
                    <div class="grid grid-cols-3 gap-5 mt-5">
                        ...
                        <div>
                            ...
                            <div class="w-full border-b-2 mt-5">&nbsp;</div>
                            <div class="">
                                <input type="text" class="border px-1 py-1 w-full" value="{{ $approved_by ? $approved_by->name : '' }}" />
                            </div>
                            <div class="">
                                <input type="text" class="border px-1 py-1 w-full" placeholder="IC No:" value="{{ $approved_by ? ic_format($approved_by->icno) : '' }}" />
                            </div>
                            <div class="">
                                <input type="text" class="border px-1 py-1 w-full" placeholder="Date:" value="{{ $voucher->approved_date ? date('d/m/Y', strtotime($voucher->approved_date)) : '' }}" />
                            </div>
                        </div>
                        <div>
                            <div>Received By</div>
